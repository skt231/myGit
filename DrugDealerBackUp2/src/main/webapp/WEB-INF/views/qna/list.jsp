  ...
  <div class="main">
    ...
    <div>
    	<select name="searchType">
    		...
    		<option value="title" <c:out value="${pageMaker.searchType eq 't'?'selected':'' }"/>>title</option>
    		<option value="content" <c:out value="${pageMaker.searchType eq 'c'?'selected':'' }"/>>content</option>
    		<option value="writer" <c:out value="${pageMaker.searchType eq 'w'?'selected':'' }"/>>writer</option>
