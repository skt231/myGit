				...
				<div class="col-lg-8 col-xl-7 col-xxl-6">
					<div class="my-5 text-center text-xl-start">
						...
						<p class="lead fw-normal text-white-50 mb-4">Quickly design
							...
							worldâs most popular front-end open source toolkit!</p>
						<div
						...
						<div class="col mb-5 h-100">
							...
							<ul>
								<c:forEach items="${list}" var="dto">
									<li>
										<a href="/ex/notice/read${pageMaker.makeSearch()}&bno=${dto.bno}">${dto.title }</a>
										
									</li>
								</c:forEach>
							</ul>
							<p><a href="/ex/notice/list">더 보기</a></p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 mb-5">
					<div class="card h-100 shadow border-0">
						...
						<div class="card-body p-4">
							...
							<a class="text-decoration-none link-dark stretched-link"
								href="#!"><h5 class="card-title mb-3">Another blog post
									title</h5></a>
