...
<body>
	...
	<form action="./ResponseLogin.jsp" method="post">
		아이디 : <input type="text" name="user_id" /><br /> 비밀번호 : <input
			type="password" name="user_pw" /> <input type="submit" value="로그인" />
	</form>

	<h2>HTTP 응답 헤더 설정하기</h2>
	<form action="ResponseHeader.jsp" method="get">
		날짜 형식 : <input type="text" name="add_date" value="2021-10-25 09:00" />
		<br /> 숫자 형식 : <input type="text" name="add_int" value="8282" /> 문자 형식
		: <input type="text" name="add_str" value="홍길동" /> <input
