...
public class CartController {
	...
	public String insertData(CartDto dto1, RedirectAttributes rttr, Model model,Authentication at) throws Exception {
		System.out.println("insert db");
		
		System.out.println(dto1.getPn());
		System.out.println(dto1.getQuantity());
