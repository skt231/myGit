...
<!-- /.box-body -->
<div class="d-grid">
	<button type="button" class="btnModify" onclick="location.href='/ex/qna/modify?bno=${list_read.bno }&title=${list_read.title}&content=${list_read.content}&writer=${list_read.writer}'">수정</button>
	<button type="submit" class="btnRemove" onclick="location.href='/ex/qna/remove?bno=${list_read.bno }&title=${list_read.title}&content=${list_read.content}&writer=${list_read.writer}'">삭제</button>
