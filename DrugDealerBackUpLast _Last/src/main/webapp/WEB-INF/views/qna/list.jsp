		...
		<table class='customers' width=100% border="1">
			...
			<c:forEach items="${list}" var="dto">
				<tr>
					...
					<td><a
						href="/ex/qna/read${pageMaker.makeSearch()}&bno=${dto.bno}&indent=${dto.indent}&depthno=${dto.depthno}">${dto.title }</a></td>
	...
	<div class="detail_list">
		<div class="orderlist">
			...
			<div class="orderdetail">
				<a href="/ex/order/selectAll">주문조회</a>
			</div>
		...
		<div class="cartlist">
			...
			<div>
				<a href="/ex/member/cart/selectAll">카트조회</a>
			</div>
