                    ...
                    <div class="row gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <hr style="color: darkgray;">
                               <h2 style="color: black; text-align:left;">${dto.price}원</h2><br>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="/ex/member/cart/insert" method="post">  
                                    <input type="hidden" name="id" value="${id }"> 
                                    <input type="hidden" name="pn" value="${dto.pn }"> 
                                    <input type="hidden" name="quantity" value="1"> 
                                    <input type="hidden" name="name" value="${dto.name }">
                                    <input type="hidden" name="price" value="${dto.price}">
                                    <input type="submit" class="btn btn-outline-dark mt-auto" style="width:150px" value="Add to Cart">
                                    </form>   
                                </div>
                            </div>
                        </div>
