...
window.onload=function(){
				...
				alert(star);
				document.getElementById("pw0000").innerHTML=star;
			}
</script>
	...
	<section class="py-5">
		...
		<div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
			...
			<div class="bodyFrame"
				...
				<p>
					<strong>비밀번호:</strong> <span id="pw0000"></span>
					<button id="changepw_bt" type="button"
						onclick="location.href='/ex/login/changePW'">수정</button>
				</p>
				<p>
				...
				<button id="resign_bt" type="button"
					onclick="location.href='/ex/users/deleteid?id=${dto.id}'">탈퇴</button>
			</div>
